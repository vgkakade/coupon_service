...
class CouponRedemption(models.Model):
    ...
    user_id = models.CharField(max_length=100, help_text="ID of the user who redeemed the coupon")
    redeemed_at = models.DateTimeField(auto_now_add=True)
    order_id = models.CharField(max_length=100, blank=True, null=True, help_text="ID of the order where the coupon was applied")
    is_active = models.BooleanField(default=True, help_text="Indicates if the redemption is still valid")
